...
void main() {
  ...
  final invalidSecp256r1SecretKey = Uint8List.fromList(List<int>.filled(31, 1));
  ...
  group('secp256r1-keypair', () {
    ...
    test('create keypair from secret key', () {
      final secretKey = Uint8List.fromList(validSecp256r1SecretKey);
      final pubKey = Uint8List.fromList(validSecp256r1PublicKey);
    ...
    test('creating keypair from invalid secret key throws error', () {
      var secretKey = Uint8List.fromList(invalidSecp256r1SecretKey);
    ...
    test('signature of data is valid', () async {
      ...
      int recId = Secp256r1Keypair.secp256r1.recoveryId(
        signature,
        msgHash,
        keypair.publicKeyBytes(false),
      );
      final publicKey = Secp256r1Keypair.secp256r1.ecRecover(
        recId,
        msgHash,
        signature,
      );
    ...
    test('incorrect purpose node for secp256r1 derivation path', () {
      expect(() {
        Secp256r1Keypair.deriveKeypair("m/74'/784'/0'/0'/0'", testMnemonic);
      }, throwsArgumentError);
    });
