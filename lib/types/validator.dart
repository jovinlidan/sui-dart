...
class ValidatorsApy {
  ValidatorsApy({required this.apys, required this.epoch});
...
class Apys {
  Apys({required this.address, required this.apy});
...
class SuiSystemStateSummary {
  ...
  SuiSystemStateSummary.fromJson(Map<String, dynamic> json) {
    ...
    atRiskValidators = List.castFrom<dynamic, dynamic>(
      json['atRiskValidators'],
    );
    validatorReportRecords = List.castFrom<dynamic, dynamic>(
...
class DelegatedStake {
  ...
  DelegatedStake.fromJson(Map<String, dynamic> json) {
    ...
    stakes = List.from(
      json['stakes'],
    ).map((e) => StakeObject.fromJson(e)).toList();
  }
...
class CommitteeInfo {
  CommitteeInfo({required this.epoch, required this.validators});
