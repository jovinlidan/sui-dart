...
abstract class Paged<T> with _$Paged<T> {
  ...
  factory Paged.fromJson(Map<String, dynamic> json, T Function(Object? json) fromJsonT) =>
      _$PagedFromJson<T>(json, fromJsonT);
}

@freezed
abstract class NextCursor with _$NextCursor {
  const factory NextCursor({required String txDigest, required String eventSeq}) = _NextCursor;
