                    ...
                    (context1, index) => GestureDetector(
                          ...
                          onTap: () async {
                            final txCall = MoveCallTransaction(packageId!, transactionModule!,
                                "burn", [], [suiObjects[index].objectId], 100000000);
          ...
          ElevatedButton(
              onPressed: () async {
                final pulishTx = PublishTransaction(
                    ContractBytes.nft_modules, ContractBytes.nft_dependencies, 100000000);
          ...
          ElevatedButton(
              onPressed: () async {
                ...
                final callTx = MoveCallTransaction(packageId!, transactionModule!, "mint", [],
                    [nftName, nftDesc, nftUrl], 100000000);
                ...
                if (resp.confirmedLocalExecution == true) {
                  ...
                  final nftObjects =
                      createdObjs?.map<SuiObject>((e) => SuiObject.fromJson(e)).toList();
